...
function Pricing() {
    return (
    <div className="relative isolate bg-[#657689] px-6 py-24 sm:py-32 lg:px-8">
      ...
      <div className="mx-auto max-w-4xl text-center">
        <h2 className="text-base/7 font-semibold text-indigo-400">J-Mobile</h2>
        <p className="mt-2 text-5xl font-semibold tracking-tight text-balance text-white sm:text-6xl">
          Pricing
        </p>
      </div>
      <p className="mx-auto mt-6 max-w-2xl text-center text-lg font-medium text-pretty text-gray-400 sm:text-xl/8">
        Choose the plan that best fits your needs. Whether that is New Phones every year or a budget friendly option!
      </p>
        ...
        {tiers.map((tier, tierIdx) => (
          <div
            ...
            className={classNames(
              tier.featured ? 'relative bg-gray-800' : 'bg-gray-800 sm:mx-8 lg:mx-0',
              tier.featured
                ? ''
                : tierIdx === 0
